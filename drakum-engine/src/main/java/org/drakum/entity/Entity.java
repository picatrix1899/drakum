...
public class Entity
{
	...
	public final StaticTransformQuat3F transform = new StaticTransformQuat3F();
	...
	{
		Mat4F scale = Mat4F.scaling3(this.transform.scale);
		Mat4F rot = Mat4F.rotationByQuat(this.transform.rot);
		Mat4F translate = Mat4F.translation3(this.transform.pos);
